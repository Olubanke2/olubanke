...
const Services = () => {
    return (
        <>
            ...
            <Container className='bg-[#878787] py-16 flex flex-col gap-8 justify-center items-center'>
                <h2 className="font-semibold text-4xl text-white">Seamless Communication. Powerful Results.</h2>
                <p className="w-1/2 text-center text-white">Inbound and outbound call solutions designed to enhance customer satisfaction, drive sales, and optimize business operations.</p>
                <div className="flex gap-6">
                    <Link to='/services/inbound-services'><button className="w-max bg-white gap-2 px-4 py-2 flex items-center">Inbound Services<MoveRight size={16} color="#404040" /></button></Link>
                    <Link to='/services/outbound-services'><button className="w-max bg-white gap-2 px-4 py-2 flex items-center">Outbound Services<MoveRight size={16} color="#404040" /></button></Link>
                </div>
            </Container>
            ...
            <Container className='py-16 text-center'>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 ">
                    <div className="h-72 bg-[#3033E9] text-white flex flex-col items-center justify-center p-4 rounded-lg card-hover">
