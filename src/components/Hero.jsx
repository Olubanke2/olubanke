...
const Hero = () => {
    return (
        <div className='px-20 h-[550px] flex items-center' style={{ backgroundImage: `url(${HeroImg})`, backgroundSize: 'cover' }}>
            <div className="flex flex-col gap-6 w-1/2">
                ...
                <h1 className=' font-bold text-6xl text-white'>Smarter Calls <br /> Better Business</h1>
